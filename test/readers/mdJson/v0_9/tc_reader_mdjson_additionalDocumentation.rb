...
require 'adiwg/mdtranslator/readers/mdJson/modules_0.9/module_additionalDocumentation'

class TestReaderMdJsonAdditionalDocumentation_v0_9 < MiniTest::Test

    # get json test example
    file = File.open('test/schemas/v0_9/examples/additionalDocumentation.json', 'r')
    jsonFile = file.read
    file.close
