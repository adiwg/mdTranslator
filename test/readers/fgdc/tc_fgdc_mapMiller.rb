...
# readers / fgdc / module_horizontalPlanar / miller cylindrical projection
...
class TestReaderFgdcPlanarMillerCylinder < TestReaderFGDCParent
   ...
   def test_horizontalPlanar_millerCylinder
      ...
      xIn = @@xDoc.xpath('./metadata/spref/horizsys/planar[12]')
      ...
      assert_equal 'miller', hProjection[:projection]
      assert_equal 'Miller Cylindrical', hProjection[:projectionName]
