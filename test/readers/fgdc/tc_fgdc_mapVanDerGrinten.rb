...
# readers / fgdc / module_horizontalPlanar / van der grinten projection
...
class TestReaderFgdcVanDerGrinten < TestReaderFGDCParent
   ...
   def test_planar_vanDerGrinten
      ...
      xIn = @@xDoc.xpath('./metadata/spref/horizsys/planar[24]')
      ...
      assert_equal 'grinten', hProjectionId[:identifier]
      assert_equal 'Van Der Grinten', hProjectionId[:name]
