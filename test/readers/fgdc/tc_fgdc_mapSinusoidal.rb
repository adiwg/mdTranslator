...
# readers / fgdc / module_horizontalPlanar / sinusoidal projection
...
class TestReaderFgdcSinusoidal < TestReaderFGDCParent
   ...
   def test_planar_sinusoidal
      ...
      xIn = @@xDoc.xpath('./metadata/spref/horizsys/planar[20]')
      ...
      assert_equal 'sinusoidal', hProjectionId[:identifier]
      assert_equal 'Sinusoidal', hProjectionId[:name]
