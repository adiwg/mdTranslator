...
# readers / fgdc / module_horizontalPlanar / polyconic projection
...
class TestReaderFgdcPolyconic < TestReaderFGDCParent
   ...
   def test_horizontalPlanar_polyconic
      ...
      xIn = @@xDoc.xpath('./metadata/spref/horizsys/planar[18]')
      ...
      assert_equal 900000.0, hProjection[:falseNorthing]
