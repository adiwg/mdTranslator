...
class TestWriter191152FeatureProperties < MiniTest::Test

    # read the ISO 19115-2 reference file
    fname = File.join(File.dirname(__FILE__), 'resultXML', '19115_2_featureProperties.xml')
    file = File.new(fname)
    ...
    fname = File.join(File.dirname(__FILE__), 'testData', '19115_2_featureProperties.json')
