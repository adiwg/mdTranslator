...
class TestWriter191151Address < TestWriter191151Parent
   ...
   #
   #    hReturn = TestWriter191151Parent.run_test(hIn, '19115_1_address', '//gmd:address[2]',
   #                                                  '//gmd:address', 0)
   #
   #    assert_equal hReturn[0], hReturn[1]
   #    assert hReturn[2]
   ...
   #
   #
   #    hReturn = TestWriter191151Parent.run_test(hIn, '19115_1_address', '//gmd:address[3]',
   #                                                   '//gmd:address', 0)
   #
   #    assert_equal hReturn[0], hReturn[1]
   #    assert hReturn[2]
   ...
   #
   #    hReturn = TestWriter191151Parent.run_test(hIn, '19115_1_address', '//gmd:address[4]',
   #                                                   '//gmd:address', 0)
   #
   #    assert_equal hReturn[0], hReturn[1]
   #    assert hReturn[2]
