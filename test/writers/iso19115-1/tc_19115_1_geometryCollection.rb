...
class TestWriter191151GeometricObject < TestWriter191151Parent
   ...
   def test_geometryCollection_complete
      ...
      hReturn = TestWriter191151Parent.run_test(hIn, '19115_1_geometryCollection',
                                                '//gex:EX_Extent[1]',
                                                '//gex:EX_Extent', 1)
   ...
   def test_geometryCollection_elements
      ...
      assert_includes hReturn[3],
         'ERROR: ISO-19115-1 writer: Geometry collection has no geometries: CONTEXT is geometry collection'
