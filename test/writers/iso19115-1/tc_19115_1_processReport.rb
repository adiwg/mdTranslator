...
# writers / iso19115_1 / class_processStepReport
...
class TestWriter191151ProcessStepReport < TestWriter191151Parent
   ...
   def test_processStepReport_complete
      ...
      hReturn = TestWriter191151Parent.run_test(hIn, '19115_1_processReport',
                                                '//mrl:report[1]',
                                                '//mrl:report', 0)
   ...
   def test_processStepReport_missing_name
      ...
      assert_includes hReturn[3], 'WARNING: ISO-19115-1 writer: process step report name is missing: CONTEXT is process step report'
