...
# writers / iso19115_1 / class_coverageDescription
...
class TestWriter191151CoverageDescription < TestWriter191151Parent
   ...
   def test_coverageInfo_image
      ...
      hReturn = TestWriter191151Parent.run_test(hIn, '19115_1_coverageDescription', '//mdb:contentInfo[2]',
                                                '//mdb:contentInfo', 0)
   ...
   def test_coverageInfo_attributeGroup
      ...
      hReturn = TestWriter191151Parent.run_test(hIn, '19115_1_coverageDescription', '//mdb:contentInfo[3]',
                                                '//mdb:contentInfo', 0)
   ...
   def test_coverageInfo_attributeGroup_multiple
      ...
      hReturn = TestWriter191151Parent.run_test(hIn, '19115_1_coverageDescription', '//mdb:contentInfo[4]',
                                                '//mdb:contentInfo', 0)
      assert_equal hReturn[0], hReturn[1]
      assert hReturn[2]
      assert_empty hReturn[3]
   ...
   def test_coverageInfo_attributeGroup_image_mix
      ...
      hReturn = TestWriter191151Parent.run_test(hIn, '19115_1_coverageDescription', '//mdb:contentInfo[5]',
                                                '//mdb:contentInfo', 0)
      assert_equal hReturn[0], hReturn[1]
      assert hReturn[2]
      assert_empty hReturn[3]
