...
# writers / iso19115_3 / class_dataIdentification
...
class TestWriter191151DataIdentification < TestWriter191151Parent
   ...
   def test_dataIdentification_minimum
      ...
      hReturn = TestWriter191151Parent.run_test(hIn, '19115_3_dataIdentification',
   ...
   def test_dataIdentification_nonCompliantTopicCategory
      ...
      assert_includes hReturn[3],'WARNING: ISO-19115-3 writer: invalid topic category: CONTEXT is invalid'
