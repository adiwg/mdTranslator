...
# writers / iso19115_3 / class_measure
...
class TestWriter191151Measure < TestWriter191151Parent
   ...
   # length not supported in 19115-3
   # scale not supported in 19115-3
   ...
   def test_measure_distance
      ...
      hReturn = TestWriter191151Parent.run_test(hIn, '19115_3_measure',
