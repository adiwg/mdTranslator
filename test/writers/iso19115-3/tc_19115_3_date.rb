...
class TestWriter191151Date < TestWriter191151Parent
   ...
   def test_date_complete
      ...
      xFile = TestWriter191151Parent.get_xml('19115_3_date')
      axExpect = xFile.xpath('//cit:date')

      hResponseObj = ADIWG::Mdtranslator.translate(
         file: hIn.to_json, reader: 'mdJson', writer: 'iso19115_3', showAllTags: true, validate: 'none'
      )
