...
# writers / iso19115_3 / class_algorithm
...
class TestWriter191151Algorithm < TestWriter191151Parent
   ...
   def test_algorithm_complete
      ...
      hReturn = TestWriter191151Parent.run_test(hIn, '19115_3_algorithm',
                                                '//mrl:algorithm[1]',
                                                '//mrl:algorithm', 0)
   ...
   def test_algorithm_missing_citation
      ...
      assert_includes hReturn[3],
                      'WARNING: ISO-19115-3 writer: algorithm citation is missing: CONTEXT is resource lineage process step PS001 processing algorithm'
   ...
   def test_algorithm_missing_description
      ...
      assert_equal 1, hReturn[3].length
      assert_includes hReturn[3],
                      'WARNING: ISO-19115-3 writer: algorithm description is missing: CONTEXT is resource lineage process step PS001 processing algorithm'
