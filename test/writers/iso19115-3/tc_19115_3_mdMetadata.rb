...
# writers / iso19115_3 / class_miMetadata
...
class TestWriter191151MDMetadata < TestWriter191151Parent
   ...
   def test_mdMetadata_complete
      ...
      xFile = TestWriter191151Parent.get_xml('19115_3_mdMetadata')
      xExpect = xFile.xpath('//mdb:MD_Metadata')

      hResponseObj = ADIWG::Mdtranslator.translate(
         file: @@mdHash.to_json, reader: 'mdJson', writer: 'iso19115_3', showAllTags: true
      )

      translatorVersion = ADIWG::Mdtranslator::VERSION
      writerVersion = ADIWG::Mdtranslator::Writers::Iso19115_3::VERSION
      ...
      assert_equal 'iso19115_3', hResponseObj[:writerRequested]
