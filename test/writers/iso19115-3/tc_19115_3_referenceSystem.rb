...
# writers / iso19115_3 / class_referenceSystem
...
class TestWriter191151ReferenceSystem < TestWriter191151Parent
   ...
   def test_referenceSystem_identifier
      ...
      hIdentifier = TDClass.build_identifier('SRS001', 'ISO 19115-3', 'srs version',
      ...
      hReturn = TestWriter191151Parent.run_test(hIn, '19115_3_referenceSystem',
   ...
   def test_referenceSystem_elements
      ...
      assert_includes hReturn[3], 'ERROR: ISO-19115-3 writer: spatial reference system identifier is missing: CONTEXT is resource spatial reference system'
      assert_includes hReturn[3], 'ERROR: ISO-19115-3 writer: spatial reference system type is missing: CONTEXT is resource spatial reference system'
