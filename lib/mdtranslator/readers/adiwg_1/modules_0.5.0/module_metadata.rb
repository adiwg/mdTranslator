...
require Mdtranslator.reader_module('module_metadataInfo', $jsonVersion)
require Mdtranslator.reader_module('module_resourceInfo', $jsonVersion)
require Mdtranslator.reader_module('module_distributionInfo', $jsonVersion)
require Mdtranslator.reader_module('module_associatedResource', $jsonVersion)
