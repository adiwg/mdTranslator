...
require Mdtranslator.reader_module('module_resourceFormat', $jsonVersion)
require Mdtranslator.reader_module('module_descriptiveKeyword', $jsonVersion)
require Mdtranslator.reader_module('module_resourceMaintenance', $jsonVersion)
require Mdtranslator.reader_module('module_resourceSpecificUsage', $jsonVersion)
require Mdtranslator.reader_module('module_browseGraphic', $jsonVersion)
require Mdtranslator.reader_module('module_legalConstraint', $jsonVersion)
require Mdtranslator.reader_module('module_securityConstraint', $jsonVersion)
require Mdtranslator.reader_module('module_taxonomy', $jsonVersion)
require Mdtranslator.reader_module('module_resolution', $jsonVersion)
require Mdtranslator.reader_module('module_extent', $jsonVersion)
require Mdtranslator.reader_module('module_dataQuality', $jsonVersion)
