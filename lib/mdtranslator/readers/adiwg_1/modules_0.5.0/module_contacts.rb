...
require Mdtranslator.reader_module('module_address', $jsonVersion)
require Mdtranslator.reader_module('module_onlineResource', $jsonVersion)
require Mdtranslator.reader_module('module_phone', $jsonVersion)
