...
require Mdtranslator.reader_module('module_geoCoordSystem', $jsonVersion)
require Mdtranslator.reader_module('module_geoProperties', $jsonVersion)
require Mdtranslator.reader_module('module_boundingBox', $jsonVersion)
require Mdtranslator.reader_module('module_point', $jsonVersion)
require Mdtranslator.reader_module('module_lineString', $jsonVersion)
require Mdtranslator.reader_module('module_polygon', $jsonVersion)
