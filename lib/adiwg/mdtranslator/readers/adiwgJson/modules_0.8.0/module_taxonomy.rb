...
require ADIWG::Mdtranslator.reader_module('module_voucher', $response[:readerVersionFound])
require ADIWG::Mdtranslator.reader_module('module_taxonClass', $response[:readerVersionFound])
