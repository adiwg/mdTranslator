...
require_relative 'module_iso19115_3'
            ...
            module Contact
               ...
               def self.unpack(xContact, hResponseObj)
                  ...
                  unless xContactInfo.empty?
                     ...
                     # error handling
                     if contactType.nil?
                        hResponseObj[:readerExecutionMessages] << 'ERROR: Iso19115_3 reader: contact is neither person or organization'
                        return nil
                     end
                     if contactType == 'person' && personName == ''
                        hResponseObj[:readerExecutionMessages] << 'WARNING: Iso19115_3 reader: contact person name is missing'
                     end
                     if contactType == 'organization' && orgName == ''
                        hResponseObj[:readerExecutionMessages] << 'WARNING: Iso19115_3 reader: contact organization name is missing'
                     end

                     # add new contacts to contact array
                     unless contactType.nil?
                        personId = Iso19115_3.add_contact(personName, false) unless personName.empty?
                        orgId = Iso19115_3.add_contact(orgName, true) unless orgName.empty?
                        hContact = Iso19115_3.get_contact_by_id(personId) if contactType == 'person'
                        hContact = Iso19115_3.get_contact_by_id(orgId) if contactType == 'organization'
                        ...
                        unless axAddress.empty?
                           axAddress.each do |xAddress|
                              ...
                              if addType.empty?
                                 hResponseObj[:readerExecutionMessages] << 'WARNING: Iso19115_3 reader: contact address type is missing'
                              end
                              ...
                              if city.empty?
                                 hResponseObj[:readerExecutionMessages] << 'WARNING: Iso19115_3 reader: contact address city is missing'
                              end
                              ...
                              if state.empty?
                                 hResponseObj[:readerExecutionMessages] << 'WARNING: Iso19115_3 reader: contact address state is missing'
                              end
                              ...
                              if postal.empty?
                                 hResponseObj[:readerExecutionMessages] << 'WARNING: Iso19115_3 reader: contact address zip code is missing'
                              end
                        ...
                        if axAddress.empty?
                           hResponseObj[:readerExecutionMessages] << 'WARNING: Iso19115_3 reader: contact address is missing'
                        end
                        ...
                        if axVoice.empty?
                           hResponseObj[:readerExecutionMessages] << 'WARNING: Iso19115_3 reader: contact voice phone is missing'
                        end
                        ...
                        Iso19115_3.set_contact(hContact)
                        ...
                        aContact = Iso19115_3.find_contact_by_id(hContact[:contactId])
