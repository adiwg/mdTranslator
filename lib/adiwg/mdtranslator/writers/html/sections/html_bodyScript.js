...
function closeDetail(summary) {
   var parentNode = document.getElementById(summary).parentNode;
...
// add event listener to side navigation buttons
var elContact = document.getElementById("contactButton");
elContact.addEventListener("click", function(){closeDetail("body-contacts")}, false);

var elMetadata = document.getElementById("metadataButton");
elMetadata.addEventListener("click", function(){closeDetail("body-metadataInfo")}, false);

var elResource = document.getElementById("resourceButton");
elResource.addEventListener("click", function(){closeDetail("body-resourceInfo")}, false);

var elLineage = document.getElementById("lineageButton");
elLineage.addEventListener("click", function(){closeDetail("body-lineage")}, false);

var elDistribution = document.getElementById("distributionButton");
elDistribution.addEventListener("click", function(){closeDetail("body-distribution")}, false);

var elAssociated = document.getElementById("associatedButton");
elAssociated.addEventListener("click", function(){closeDetail("body-associatedResource")}, false);

var elAdditional = document.getElementById("additionalButton");
elAdditional.addEventListener("click", function(){closeDetail("body-additionalDocument")}, false);

var elDictionary = document.getElementById("dictionaryButton");
elDictionary.addEventListener("click", function(){closeDetail("body-dataDictionary")}, false);

var elFunding = document.getElementById("fundingButton");
elFunding.addEventListener("click", function(){closeDetail("body-funding")}, false);

var elRepository = document.getElementById("repositoryButton");
elRepository.addEventListener("click", function(){closeDetail("body-repository")}, false);
